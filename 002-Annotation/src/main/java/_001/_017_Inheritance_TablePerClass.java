...
Child class tables has all the columns related to parent's property, including parent's generatedValue. So each child has an Id as well generated by 
hibernate
You dont have a discriminator here. Infact you dont need it since you have separate table for separate class
The tables are slighly more normalized. Unlike single class strategy, you dont have extra columns which do not have data. But this strategy repeats 
